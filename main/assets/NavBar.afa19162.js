import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.de9a3643.js";import{s as r,j as h,a as t,C as d}from"./index.6a46d10b.js";import{c as s,t as o}from"./theme.6118982a.js";import{$ as H}from"./Button.module.f46ebf71.js";import{B as y}from"./BodyPortal.d1d03d9b.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
