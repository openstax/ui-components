import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.943e4e80.js";import{s as r,j as h,a as t,C as d}from"./index.8ec087ea.js";import{c as s,t as o}from"./theme.e9f3b33a.js";import{$ as H}from"./OverlayArrow.module.5526dcaf.js";import{B as y}from"./BodyPortal.b86a7cda.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
