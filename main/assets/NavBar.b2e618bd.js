...
`,y=h.div`
  ...
  margin: 0 auto;
  ${e=>a.breakpoints.desktop(i`
    height: ${e.navDesktopHeight}rem;
  `)}
  @media print { display: none; }
`,B=({logo:e=!1,maxWidth:s,navDesktopHeight:v,navMobileHeight:r,justifyContent:d,...o})=>{const l=typeof e=="object",m=l&&"href"in e,{alt:p="OpenStax Logo",...g}=l?e:{},n=e?t(w,{alt:p}):null;return t(x,{tagName:"nav",slot:"nav",...o,children:c(y,{maxWidth:s,navDesktopHeight:v||f,navMobileHeight:r||H,justifyContent:d,children:[m?t("a",{...g,children:n}):n,o.children]})})};export{B as N,w as a};
