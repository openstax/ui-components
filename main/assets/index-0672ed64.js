...
`,ee=({items:t,selectedItems:e,...d})=>m(U,{selectedKeys:e,...d,children:t.map(({value:s,...a})=>m(_,{"data-button-id":a.id,...a,onPressStart:i=>i.continuePropagation(),children:s},a.id))});export{ee as T};
