...
export const Light = () => (
  <>
    ...
    <Button variant="light" isWaiting={true} waitingText="Waiting...">
      Button
    </Button>
  </>
);
...
export const Secondary = () => (
  <>
    ...
    <Button variant="secondary" isWaiting={true} waitingText="Waiting...">
      Button
    </Button>
  </>
);
...
export const Link = () => (
  <>
    ...
    <LinkButton variant="secondary" href="https://openstax.org" target="_blank">
      Button
    </LinkButton>
  </>
);
