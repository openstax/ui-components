...
`,M=a.div`
  ...
  margin: 0 auto;
  ${t=>n.breakpoints.desktop(l`
    height: ${t.navDesktopHeight}rem;
  `)}
  @media print { display: none; }
`,o=({logo:t=!1,maxWidth:r,...i})=>{const h=typeof t=="object",s=h&&"href"in t,{alt:v="OpenStax Logo",...m}=h?t:{},c=t?e(w,{alt:v}):null;return e(k,{children:d(M,{maxWidth:r,navDesktopHeight:i.navDesktopHeight||g,navMobileHeight:i.navMobileHeight||p,justifyContent:i.justifyContent,children:[s?e("a",{...m,children:c}):c,i.children]})})},$=()=>e(o,{children:"NavBar"}),L=()=>e(o,{logo:!0,children:"Menu"}),j=()=>e(o,{logo:{alt:"custom alt",href:"/"}}),C=()=>e(o,{logo:{alt:"custom alt unlinked"}}),z=()=>e(o,{justifyContent:"center",children:e("strong",{children:"Centered Menu"})});typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{j as AltTextLinkedLogo,C as AltTextNoLinkedLogo,L as LogoAndChildren,z as OverrideJustifyContent,$ as Plain};
