import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.2f92329a.js";import{s as r,j as h,a as t,C as d}from"./index.8f51e422.js";import{c as s,t as o}from"./theme.2cc37264.js";import{$ as H}from"./Button.module.ebb80593.js";import{B as y}from"./BodyPortal.9755886e.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
