import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.51c33f22.js";import{s as r,j as h,a as t,C as d}from"./index.cf24ef3b.js";import{c as s,t as o}from"./theme.f1fb32ed.js";import{$ as H}from"./OverlayArrow.module.84d9e499.js";import{B as y}from"./BodyPortal.cdbf0bf6.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
