import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.c688e8b7.js";import{s as r,j as h,a as t,C as d}from"./index.2c8eae54.js";import{c as s,t as o}from"./theme.06c06756.js";import{$ as H}from"./OverlayArrow.module.10a99003.js";import{a as y}from"./BodyPortal.419f0970.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
