...
`,$=i.div`
  ...
  margin: 0 auto;
  ${t=>o.breakpoints.desktop(l`
    height: ${t.navDesktopHeight}rem;
  `)}
  @media print { display: none; }
`,n=({logo:t=!1,maxWidth:d,navDesktopHeight:s,navMobileHeight:v,justifyContent:m,...a})=>{const h=typeof t=="object",g=h&&"href"in t,{alt:p="OpenStax Logo",...b}=h?t:{},c=t?e(x,{alt:p}):null;return e(H,{role:"toolbar",...a,children:r($,{maxWidth:d,navDesktopHeight:s||f,navMobileHeight:v||u,justifyContent:m,children:[g?e("a",{...b,children:c}):c,a.children]})})},C=()=>e(n,{children:"NavBar"}),z=()=>e(n,{logo:!0,children:"Menu"}),A=()=>e(n,{logo:{alt:"custom alt",href:"/"}}),B=()=>e(n,{logo:{alt:"custom alt unlinked"}}),D=()=>e(n,{justifyContent:"center",children:e("strong",{children:"Centered Menu"})});typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{A as AltTextLinkedLogo,B as AltTextNoLinkedLogo,z as LogoAndChildren,D as OverrideJustifyContent,C as Plain};
