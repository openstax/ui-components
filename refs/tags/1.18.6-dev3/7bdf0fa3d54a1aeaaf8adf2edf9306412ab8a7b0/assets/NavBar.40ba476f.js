import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.acd7ba1f.js";import{s as r,j as h,a as t,C as d}from"./index.924fd51e.js";import{c as s,t as o}from"./theme.848ff9a2.js";import{$ as H}from"./Button.module.06a19140.js";import{B as y}from"./BodyPortal.be6d849e.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
