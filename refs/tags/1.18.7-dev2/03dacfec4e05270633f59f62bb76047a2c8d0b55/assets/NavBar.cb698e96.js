import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.e06c4df6.js";import{s as r,j as h,a as t,C as d}from"./index.3d937027.js";import{c as s,t as o}from"./theme.faf9aa84.js";import{$ as H}from"./Button.module.40eb5513.js";import{B as y}from"./BodyPortal.96523e4b.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
