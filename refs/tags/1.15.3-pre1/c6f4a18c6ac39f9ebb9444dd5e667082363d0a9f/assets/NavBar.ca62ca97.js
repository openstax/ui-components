import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.43bb7332.js";import{s as r,j as h,a as t,C as d}from"./index.21e3657a.js";import{c as s,t as o}from"./theme.0a759f82.js";import{$ as H}from"./OverlayArrow.module.2013dc1b.js";import{a as y}from"./BodyPortal.92585f49.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
