import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.64dcea4d.js";import{s as r,j as h,a as t,C as d}from"./index.01482421.js";import{c as s,t as o}from"./theme.b1025011.js";import{$ as H}from"./OverlayArrow.module.49da0f69.js";import{B as y}from"./BodyPortal.f6a91036.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
