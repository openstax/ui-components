import{s as h,C as i,j as c,a as t}from"./index.358353a8.js";import{t as a}from"./theme.2852186b.js";import{B as b}from"./BodyPortal.95feb63e.js";const f=4,w=4,H=2.4,M=2.4,$=h.svg`
  display: block;
  width: auto;
  height: ${M}rem;
...
`,B=({logo:e=!1,maxWidth:s,navDesktopHeight:v,navMobileHeight:r,justifyContent:d,...o})=>{const l=typeof e=="object",m=l&&"href"in e,{alt:p="OpenStax Logo",...g}=l?e:{},n=e?t(k,{alt:p}):null;return t(x,{tagName:"nav",slot:"nav",...o,children:c(y,{maxWidth:s,navDesktopHeight:v||f,navMobileHeight:r||w,justifyContent:d,children:[m?t("a",{...g,children:n}):n,o.children]})})};export{B as N,k as a};
