import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.32c30eab.js";import{s as r,j as h,a as t,C as d}from"./index.456f62bb.js";import{c as s,t as o}from"./theme.e48aaf48.js";import{$ as H}from"./Button.module.66a51b0a.js";import{B as y}from"./BodyPortal.c422232c.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
