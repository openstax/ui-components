import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.d834d3f1.js";import{s as r,j as h,a as t,C as d}from"./index.7e4e779f.js";import{c as s,t as o}from"./theme.bd757b8d.js";import{$ as H}from"./OverlayArrow.module.dadc457d.js";import{a as y}from"./BodyPortal.bee3c2ae.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
