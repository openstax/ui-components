import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.bebad125.js";import{s as r,j as h,a as t,C as d}from"./index.c9c1760a.js";import{c as s,t as o}from"./theme.784106f9.js";import{$ as H}from"./OverlayArrow.module.e0f4f6f5.js";import{B as y}from"./BodyPortal.c96276b3.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
