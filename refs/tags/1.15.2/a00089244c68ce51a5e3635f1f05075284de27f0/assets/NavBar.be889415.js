import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.741b8f86.js";import{s as r,j as h,a as t,C as d}from"./index.7b15cc21.js";import{c as s,t as o}from"./theme.670e9418.js";import{$ as H}from"./OverlayArrow.module.39a84c81.js";import{a as y}from"./BodyPortal.8af334ad.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
