import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.2529405e.js";import{s as r,j as h,a as t,C as d}from"./index.227eb4a7.js";import{c as s,t as o}from"./theme.0f1f64fc.js";import{$ as H}from"./OverlayArrow.module.888dbaed.js";import{B as y}from"./BodyPortal.7f1f4b79.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
