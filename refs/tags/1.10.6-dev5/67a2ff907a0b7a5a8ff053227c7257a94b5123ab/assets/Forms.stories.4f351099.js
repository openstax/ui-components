import{s as m,a as n,F as x,j as u,R as d}from"./index.e2c08fa7.js";import"./Radio.b4c44843.js";import"./theme.b9535cc3.js";import"./palette.15e4d008.js";import"./Tooltip.cf5e4a0c.js";import"./OverlayArrow.module.593e7fbf.js";import"./focusSafely.module.61bf43db.js";import"./context.module.9a4dbe5e.js";import"./Info.d7b9a859.js";var y={};(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.stateHasError=e.stateHasData=e.fetchIdle=e.fetchSuccess=e.fetchError=e.fetchLoading=e.FetchStateType=void 0;var t;(function(o){o.SUCCESS="success",o.ERROR="error",o.LOADING="loading",o.IDLE="idle"})(t=e.FetchStateType||(e.FetchStateType={}));const i=o=>({type:t.LOADING,...o&&"data"in o?{data:o.data}:{}});e.fetchLoading=i;const a=(o,f)=>({...f,type:t.ERROR,error:o});e.fetchError=a;const r=o=>({type:t.SUCCESS,data:o});e.fetchSuccess=r;const s=()=>({type:t.IDLE});e.fetchIdle=s;const c=o=>"data"in o;e.stateHasData=c;const l=o=>"error"in o;e.stateHasError=l})(y);const H=m.label`
  display: flex;
