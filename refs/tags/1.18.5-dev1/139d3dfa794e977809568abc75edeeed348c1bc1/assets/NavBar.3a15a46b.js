import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.4ff72bb4.js";import{s as r,j as h,a as t,C as d}from"./index.040b9f37.js";import{c as s,t as o}from"./theme.08015d47.js";import{$ as H}from"./Button.module.df0878e7.js";import{B as y}from"./BodyPortal.41531336.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
