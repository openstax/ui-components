import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.31ef6523.js";import{s as r,j as h,a as t,C as d}from"./index.614bee7f.js";import{c as s,t as o}from"./theme.aaf51a92.js";import{$ as H}from"./Button.module.fec8517f.js";import{B as y}from"./BodyPortal.778accb7.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
