import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.f254a4f0.js";import{s as r,j as h,a as t,C as d}from"./index.aa197b2c.js";import{c as s,t as o}from"./theme.3d7efd7e.js";import{$ as H}from"./OverlayArrow.module.229435cc.js";import{a as y}from"./BodyPortal.331a5723.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
