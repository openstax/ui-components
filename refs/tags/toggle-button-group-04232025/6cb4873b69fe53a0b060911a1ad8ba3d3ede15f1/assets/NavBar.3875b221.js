import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.fb89f950.js";import{s as r,j as h,a as t,C as d}from"./index.722bcc42.js";import{c as s,t as o}from"./theme.c3194663.js";import{$ as H}from"./OverlayArrow.module.ad1eabed.js";import{B as y}from"./BodyPortal.75f0a743.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
