...
`,M=({className:t,heading:i,onModalClose:s,children:c,show:p,variant:l})=>p?n(x,{className:t,children:[r(v,{children:n(f,{children:[n(u,{variant:l,children:[r(b,{children:i}),r(g,{onClick:s,variant:l})]}),c]})}),r($,{})]}):null;export{g as C,y as M,k as a,M as b,L as c,$ as d,x as e};
