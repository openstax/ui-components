import{s as m,a as n,F as x,j as u,R as d}from"./index.b1c0c990.js";import"./Radio.a8857563.js";import"./theme.d4b7cbef.js";import"./palette.15e4d008.js";import"./Tooltip.9ce5e2e5.js";import"./OverlayArrow.module.e5d21536.js";import"./focusSafely.module.928e7deb.js";import"./context.module.eafe6d51.js";import"./Info.4d36d9bd.js";var y={};(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.stateHasError=e.stateHasData=e.fetchIdle=e.fetchSuccess=e.fetchError=e.fetchLoading=e.FetchStateType=void 0;var t;(function(o){o.SUCCESS="success",o.ERROR="error",o.LOADING="loading",o.IDLE="idle"})(t=e.FetchStateType||(e.FetchStateType={}));const i=o=>({type:t.LOADING,...o&&"data"in o?{data:o.data}:{}});e.fetchLoading=i;const a=(o,f)=>({...f,type:t.ERROR,error:o});e.fetchError=a;const r=o=>({type:t.SUCCESS,data:o});e.fetchSuccess=r;const s=()=>({type:t.IDLE});e.fetchIdle=s;const c=o=>"data"in o;e.stateHasData=c;const l=o=>"error"in o;e.stateHasError=l})(y);const H=m.label`
  display: flex;
