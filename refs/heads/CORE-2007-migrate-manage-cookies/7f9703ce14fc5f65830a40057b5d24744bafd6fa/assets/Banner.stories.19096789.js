...
`,s=e=>{const r=e.messages.length;return d(v,{severity:e.severity,children:[d("div",{children:[e.severity!=="error"?n(u,{children:e.severity==="note"?"Note: ":"Warning: "}):null,e.messages.map((a,l)=>n(c,{block:r>1,children:r>1?`[${l+1} of ${r}]: ${a}`:a},l))]}),e.onDismiss?n(f,{severity:e.severity,onClick:e.onDismiss,"aria-label":"dismiss",children:n(h,{"aria-hidden":"true",focusable:"false"})}):null]})},t=o.div`
  font-size: 1.2rem;
  position: relative;
  padding-right: 2.5rem;
  width: 42rem;
`,L=()=>n(t,{children:n(s,{messages:["This is an error message"],severity:"error"})}),k=()=>n(t,{children:n(s,{messages:["This is a warning message"],severity:"warning"})}),$=()=>n(t,{children:n(s,{messages:["This is a note message"],severity:"note"})}),B=()=>n(t,{children:n(s,{messages:["First message","Second message","Third message"],severity:"warning"})}),R=()=>{const[e,r]=m.useState(!0);return e?n(t,{children:n(s,{messages:["This is a dismissible warning message"],severity:"warning",onDismiss:()=>r(!1)})}):null};typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{R as Dismissible,L as Error,B as MultipleMessages,$ as Note,k as Warning};
