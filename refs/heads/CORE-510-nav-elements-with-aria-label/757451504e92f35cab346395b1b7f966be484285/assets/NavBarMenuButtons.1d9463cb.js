import{s as r,C as d,j as h,a as t}from"./index.d9b1cd26.js";import{t as o,c as s}from"./theme.949ce14b.js";import{B as u}from"./BodyPortal.21c94eea.js";import{c as x,b as B,a as w,m as k,$ as M,l as H}from"./Dialog.module.df9c0f2c.js";import{$ as y}from"./OverlayArrow.module.e2127d40.js";const N=4,L=4,z=2.4,j=2.4,C=r.svg`
  display: block;
  width: auto;
  height: ${j}rem;
...
`,E=({logo:e=!1,maxWidth:a,navDesktopHeight:n,navMobileHeight:c,justifyContent:i,ariaLabel:l,...m})=>{const v=typeof e=="object",b=v&&"href"in e,{alt:f="OpenStax Logo",...$}=v?e:{},p=e?t(P,{alt:f}):null;return t(D,{tagName:"nav",ariaLabel:l,slot:"nav",...m,children:h(V,{maxWidth:a,navDesktopHeight:n||N,navMobileHeight:c||L,justifyContent:i,children:[b?t("a",{...$,children:p}):p,m.children]})})},I=r(({label:e,icon:a,className:n,"aria-label":c,...i})=>h(y,{className:n,...i,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
...
`,g=({isMenu:e,children:a,popoverProps:n,...c})=>{const i=e?w:k,l=e?M:H;return h(i,{children:[t(I,{...c}),t(W,{...n,children:t(l,{children:a})})]})},J=e=>t(g,{...e,isMenu:!1}),K=e=>t(g,{...e,isMenu:!0});export{I as N,F as P,K as a,S as b,J as c,E as d,P as e};
