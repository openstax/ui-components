import{s as m,a as n,F as x,j as u,R as d}from"./index.66d9f391.js";import"./Radio.9cd76046.js";import"./theme.0311f00b.js";import"./palette.15e4d008.js";import"./Tooltip.71f96efb.js";import"./OverlayArrow.module.597b121f.js";import"./focusSafely.module.7b71a959.js";import"./context.module.25d6573d.js";import"./Info.36c0be75.js";var y={};(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.stateHasError=e.stateHasData=e.fetchIdle=e.fetchSuccess=e.fetchError=e.fetchLoading=e.FetchStateType=void 0;var t;(function(o){o.SUCCESS="success",o.ERROR="error",o.LOADING="loading",o.IDLE="idle"})(t=e.FetchStateType||(e.FetchStateType={}));const i=o=>({type:t.LOADING,...o&&"data"in o?{data:o.data}:{}});e.fetchLoading=i;const a=(o,f)=>({...f,type:t.ERROR,error:o});e.fetchError=a;const r=o=>({type:t.SUCCESS,data:o});e.fetchSuccess=r;const s=()=>({type:t.IDLE});e.fetchIdle=s;const c=o=>"data"in o;e.stateHasData=c;const l=o=>"error"in o;e.stateHasError=l})(y);const H=m.label`
  display: flex;
