import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.fbb2ba57.js";import{s as r,j as h,a as t,C as d}from"./index.2e188ec9.js";import{c as s,t as o}from"./theme.38d1f9b8.js";import{$ as H}from"./OverlayArrow.module.f177c9be.js";import{a as y}from"./BodyPortal.1b64057f.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
