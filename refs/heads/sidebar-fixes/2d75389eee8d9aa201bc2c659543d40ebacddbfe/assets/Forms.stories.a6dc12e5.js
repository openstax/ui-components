import{s as m,a as n,F as x,j as u,R as d}from"./index.85c550ff.js";import"./Radio.d7e3e53d.js";import"./theme.e63e1088.js";import"./palette.15e4d008.js";import"./Tooltip.ffb867b9.js";import"./OverlayArrow.module.1c5a12b4.js";import"./focusSafely.module.df28f373.js";import"./context.module.ee7e2f16.js";import"./Info.0f5ed35e.js";var y={};(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.stateHasError=e.stateHasData=e.fetchIdle=e.fetchSuccess=e.fetchError=e.fetchLoading=e.FetchStateType=void 0;var t;(function(o){o.SUCCESS="success",o.ERROR="error",o.LOADING="loading",o.IDLE="idle"})(t=e.FetchStateType||(e.FetchStateType={}));const i=o=>({type:t.LOADING,...o&&"data"in o?{data:o.data}:{}});e.fetchLoading=i;const a=(o,f)=>({...f,type:t.ERROR,error:o});e.fetchError=a;const r=o=>({type:t.SUCCESS,data:o});e.fetchSuccess=r;const s=()=>({type:t.IDLE});e.fetchIdle=s;const c=o=>"data"in o;e.stateHasData=c;const l=o=>"error"in o;e.stateHasError=l})(y);const H=m.label`
  display: flex;
