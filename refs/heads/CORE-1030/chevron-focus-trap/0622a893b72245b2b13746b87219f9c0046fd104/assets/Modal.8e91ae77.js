...
`,he=({className:t,heading:e,onModalClose:i,children:a,show:n,variant:r,...l})=>n?s(oe,{className:t,isDismissable:!0,onOpenChange:d=>!d&&i(),...l,children:s(le,{children:s(se,{children:w(ne,{children:[w(re,{variant:r,children:[s(de,{slot:"title",children:e}),s(ae,{onClick:i,variant:r})]}),a]})})})}):null;export{ae as C,ge as M,pe as a,he as b,be as c,oe as d,le as e};
