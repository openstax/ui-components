...
`,se=({items:t,selectedItems:e,onSelectionChange:d,selectionMode:a="single",...s})=>h(q,{selectionMode:a,selectedKeys:e,onSelectionChange:d,...s,children:t.map(i=>h(J,{"data-button-id":i.id,id:i.id,onPressStart:r=>r.continuePropagation(),children:i.value},i.id))});export{se as T};
