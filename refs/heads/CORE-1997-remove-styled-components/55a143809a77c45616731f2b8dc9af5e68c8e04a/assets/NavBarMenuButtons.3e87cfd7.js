import{s as n,j as h,a as t}from"./index.b41e8d47.js";import{t as o,c as s,d as $}from"./theme.469067e1.js";import{B as u}from"./BodyPortal.e3c074e6.js";import{c as x,b as B,a as k,l as w,$ as M,k as H}from"./Dialog.module.89a02ff0.js";import{$ as y}from"./Button.module.b64dbec1.js";const N=4,z=4,L=2.4,j=2.4,P=n.svg`
  display: block;
  width: auto;
  height: ${j}rem;
...
`,q=({logo:e=!1,maxWidth:a,navDesktopHeight:i,navMobileHeight:r,justifyContent:c,ariaLabel:l,...d})=>{const m=typeof e=="object",g=m&&"href"in e,{alt:b="OpenStax Logo",...f}=m?e:{},v=e?t(D,{alt:b}):null;return t(V,{tagName:"nav",ariaLabel:l,slot:"nav",...d,children:h(C,{maxWidth:a,navDesktopHeight:i||N,navMobileHeight:r||z,justifyContent:c,children:[g?t("a",{...f,children:v}):v,d.children]})})},I=n(({label:e,icon:a,className:i,"aria-label":r,...c})=>h(y,{className:i,"aria-label":r,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
...
`,p=({isMenu:e,children:a,popoverProps:i,...r})=>{const c=e?k:w,l=e?M:H;return h(c,{children:[t(I,{...r}),t(S,{...i,children:t(l,{children:a})})]})},J=e=>t(p,{...e,isMenu:!1}),K=e=>t(p,{...e,isMenu:!0});export{I as N,E as P,K as a,O as b,J as c,q as d,D as e,S as f};
