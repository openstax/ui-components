...
`,ae=({items:t,selectedItems:e,...s})=>x(_,{selectedKeys:e,...s,children:t.map(({value:o,...a})=>x(J,{"data-button-id":a.id,...a,onPressStart:i=>i.continuePropagation(),children:o},a.id))});export{ae as T};
