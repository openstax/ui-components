import{W as r,a as e,j as n,F as d,R as c,s as h}from"./index.91fa91fe.js";import{a as u}from"./Button.4bc9da9e.js";import"./palette.15e4d008.js";const w=r`
  .osano-cm-widget { display: none; }
`,t=o=>{const i=typeof window>"u"?void 0:window.Osano;if(i===void 0||i.cm.mode==="debug")return null;const l=e(u,{...o,onClick:a=>{var s;i.cm.showDrawer("osano-cm-dom-info-dialog-open"),(s=o.onClick)==null||s.call(o,a)},children:"Manage Cookies"});return n(d,{children:[e(w,{}),typeof o.children=="function"?o.children(l):l]})},b=()=>{const[o,i]=c.useState(!1);return c.useEffect(()=>i(!0),[]),n(d,{children:[e("div",{className:"osano-cm-widget",children:"mock osano cookie button"}),o?e(t,{}):null,n("ul",{children:[e("li",{children:"in a list"}),e("li",{children:"use a function child to provide wrappers that will only be included if the link is shown"}),e(t,{children:l=>e("li",{children:l})})]})]})},m=h.div`
  a, button {
    color: #ccc;
