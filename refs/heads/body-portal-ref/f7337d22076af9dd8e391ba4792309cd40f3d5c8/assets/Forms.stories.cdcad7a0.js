import{s as m,a as n,F as x,j as u,R as d}from"./index.041d0a60.js";import"./Radio.96157dc8.js";import"./theme.c1cfd40e.js";import"./palette.15e4d008.js";import"./Tooltip.e8476f07.js";import"./OverlayArrow.module.44a066d5.js";import"./focusSafely.module.c14bd131.js";import"./context.module.20f2eb57.js";import"./Info.ed113384.js";var y={};(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.stateHasError=e.stateHasData=e.fetchIdle=e.fetchSuccess=e.fetchError=e.fetchLoading=e.FetchStateType=void 0;var t;(function(o){o.SUCCESS="success",o.ERROR="error",o.LOADING="loading",o.IDLE="idle"})(t=e.FetchStateType||(e.FetchStateType={}));const i=o=>({type:t.LOADING,...o&&"data"in o?{data:o.data}:{}});e.fetchLoading=i;const a=(o,f)=>({...f,type:t.ERROR,error:o});e.fetchError=a;const r=o=>({type:t.SUCCESS,data:o});e.fetchSuccess=r;const s=()=>({type:t.IDLE});e.fetchIdle=s;const c=o=>"data"in o;e.stateHasData=c;const l=o=>"error"in o;e.stateHasError=l})(y);const H=m.label`
  display: flex;
