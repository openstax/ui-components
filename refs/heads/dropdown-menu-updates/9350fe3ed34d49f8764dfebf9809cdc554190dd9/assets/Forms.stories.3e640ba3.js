import{s as m,a as n,F as x,j as u,R as d}from"./index.ca05a9ee.js";import"./Radio.ff5938f7.js";import"./theme.986a8d87.js";import"./palette.15e4d008.js";import"./Tooltip.648cce49.js";import"./module.7c841851.js";import"./Info.7cadf7a9.js";var y={};(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.stateHasError=e.stateHasData=e.fetchIdle=e.fetchSuccess=e.fetchError=e.fetchLoading=e.FetchStateType=void 0;var t;(function(o){o.SUCCESS="success",o.ERROR="error",o.LOADING="loading",o.IDLE="idle"})(t=e.FetchStateType||(e.FetchStateType={}));const i=o=>({type:t.LOADING,...o&&"data"in o?{data:o.data}:{}});e.fetchLoading=i;const a=(o,f)=>({...f,type:t.ERROR,error:o});e.fetchError=a;const r=o=>({type:t.SUCCESS,data:o});e.fetchSuccess=r;const s=()=>({type:t.IDLE});e.fetchIdle=s;const c=o=>"data"in o;e.stateHasData=c;const l=o=>"error"in o;e.stateHasError=l})(y);const H=m.label`
  display: flex;
...
`,ge=()=>{const e={name:"Test McTesterson",interests:[{interest:"sleeping"}]},t=y.fetchSuccess(e),[i,a]=d.useState({}),[r,s]=d.useState(!1);return u(I,{state:t,onSubmit:c=>a(c),children:[n(b,{name:"name",label:"Name"}),n(z,{name:"sortable",label:"Sortable",onChangeValue:c=>s(!!c)}),u(p,{name:"interests",children:[n(A,{children:u(B,{children:[r?n(ie,{style:{height:"auto"}}):null,n(b,{name:"interest",label:"Interest"}),n(M,{children:"remove interest"})]})}),n(J,{children:"add interest"})]}),n(w,{}),n("pre",{children:JSON.stringify(i,null,2)})]})},ye=()=>{const e={name:"Test McTesterson"},t=y.fetchSuccess(e);return u(I,{state:t,children:[n(b,{name:"name",label:"Name"}),n(w,{}),n(T,{name:"name",children:i=>n("pre",{children:JSON.stringify(i,null,2)})}),n(v,{children:i=>n("pre",{children:JSON.stringify(i,null,2)})})]})},ve=()=>{const e={name:"Test McTesterson",interests:[{interest:"sleeping"}],address:{line1:"1 main st"}},t=y.fetchSuccess(e);return u(I,{state:t,children:[n(b,{name:"name",label:"Name"}),u("p",{children:["in a loop or namespace ",n("code",{children:"Forms.GetFormData"})," and ",n("code",{children:"Forms.GetFormValue"})," will return only values within the namespace"]}),n(v,{children:i=>u(x,{children:[u(se,{name:"address",children:[n(b,{name:"line1",label:"line1"}),n(v,{children:a=>n("pre",{children:JSON.stringify(a,null,2)})}),n("p",{children:"if you need the parent context data in a subcomponent, you can wrap the entire section"}),n("pre",{children:JSON.stringify(i,null,2)})]}),u(p,{name:"interests",children:[u(A,{children:[u(B,{children:[n(b,{name:"interest",label:"Interest"}),n(M,{children:"remove interest"})]}),n(v,{children:a=>n("pre",{children:JSON.stringify(a,null,2)})})]}),n(J,{children:"add interest"})]}),n(w,{}),n(T,{name:"name",children:a=>n("pre",{children:JSON.stringify(a,null,2)})})]})})]})};typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{be as BasicControlledForm,ye as BasicDataReferences,ve as DataReferencesInNamespaces,ge as FormRepeatableElements};
