import{s as r,C as d,j as l,a as t}from"./index.954e3bd6.js";import{t as o,c as s}from"./theme.02a10726.js";import{B as $}from"./BodyPortal.24dae221.js";import{$ as u,o as x,n as B}from"./Dialog.module.68250b15.js";import{b as w,a as k,$ as M}from"./Menu.module.fb5ac4a0.js";import{$ as H}from"./Button.module.7f8455ba.js";const y=4,N=4,L=2.4,z=2.4,j=r.svg`
  display: block;
  width: auto;
  height: ${z}rem;
...
`,E=({logo:e=!1,maxWidth:a,navDesktopHeight:n,navMobileHeight:c,justifyContent:i,...h})=>{const m=typeof e=="object",g=m&&"href"in e,{alt:b="OpenStax Logo",...f}=m?e:{},v=e?t(C,{alt:b}):null;return t(P,{tagName:"nav",slot:"nav",...h,children:l(D,{maxWidth:a,navDesktopHeight:n||y,navMobileHeight:c||N,justifyContent:i,children:[g?t("a",{...f,children:v}):v,h.children]})})},V=r(({label:e,icon:a,className:n,"aria-label":c,...i})=>l(H,{className:n,...i,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
...
`,p=({isMenu:e,children:a,popoverProps:n,...c})=>{const i=e?k:x,h=e?M:B;return l(i,{children:[t(V,{...c}),t(S,{...n,children:t(h,{children:a})})]})},J=e=>t(p,{...e,isMenu:!1}),K=e=>t(p,{...e,isMenu:!0});export{V as N,F as P,K as a,I as b,J as c,E as d,C as e};
