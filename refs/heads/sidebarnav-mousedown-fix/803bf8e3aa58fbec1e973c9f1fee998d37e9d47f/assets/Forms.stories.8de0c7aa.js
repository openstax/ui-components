import{s as m,a as n,F as x,j as u,R as d}from"./index.f350c878.js";import"./Radio.d2b9c730.js";import"./theme.b725fa60.js";import"./palette.15e4d008.js";import"./Tooltip.58cd18c2.js";import"./OverlayArrow.module.f9c1b9d4.js";import"./focusSafely.module.11d247d0.js";import"./context.module.13429728.js";import"./Info.f03c0b97.js";var y={};(function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.stateHasError=e.stateHasData=e.fetchIdle=e.fetchSuccess=e.fetchError=e.fetchLoading=e.FetchStateType=void 0;var t;(function(o){o.SUCCESS="success",o.ERROR="error",o.LOADING="loading",o.IDLE="idle"})(t=e.FetchStateType||(e.FetchStateType={}));const i=o=>({type:t.LOADING,...o&&"data"in o?{data:o.data}:{}});e.fetchLoading=i;const a=(o,f)=>({...f,type:t.ERROR,error:o});e.fetchError=a;const r=o=>({type:t.SUCCESS,data:o});e.fetchSuccess=r;const s=()=>({type:t.IDLE});e.fetchIdle=s;const c=o=>"data"in o;e.stateHasData=c;const l=o=>"error"in o;e.stateHasError=l})(y);const H=m.label`
  display: flex;
