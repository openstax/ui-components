...
`,ve=({children:t,placement:e,icon:r,...a})=>C(be,{...a,placement:e,children:[u(D,{children:u("svg",{width:8,height:8,viewBox:"0 0 8 8",children:u("path",{d:"M0 0 L4 4 L8 0",stroke:"#ccc",strokeWidth:"1"})})}),t]}),Ce=({icon:t,ariaLabel:e,...r})=>C(ue,{delay:0,children:[u(ge,{"aria-label":e||"More information",children:t?u("img",{src:t,"aria-hidden":!0,alt:""}):u(oe,{"aria-hidden":!0})}),u(ve,{...r})]}),Re=({state:t,...e})=>{const{tooltipProps:r}=M(e,t);return C(xe,{"data-placement":e.placement,...y(e,r),children:[e.children,u(D,{...e,children:u("svg",{width:8,height:8,viewBox:"0 0 8 8",children:u("path",{d:"M0 0 L4 4 L8 0",stroke:"#ccc",strokeWidth:"1"})})})]})};export{A as $,Re as C,Ce as T,se as a};
