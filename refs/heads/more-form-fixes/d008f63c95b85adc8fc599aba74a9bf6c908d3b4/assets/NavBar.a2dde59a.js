import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.f28952c6.js";import{s as r,j as h,a as t,C as d}from"./index.df7d58c7.js";import{c as s,t as o}from"./theme.31cfe468.js";import{$ as H}from"./OverlayArrow.module.e1766d59.js";import{B as y}from"./BodyPortal.a9e0e8c7.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
...
`,g=({isMenu:e,children:a,popoverProps:n,...i})=>{const c=e?B:w,l=e?k:M;return h(c,{children:[t(N,{...i}),t(L,{...n,children:t(l,{children:a})})]})},F=e=>t(g,{...e,isMenu:!1}),J=e=>t(g,{...e,isMenu:!0}),j=4,C=4,P=2.4,D=2.4,V=r.svg`
  display: block;
  width: auto;
  height: ${D}rem;
