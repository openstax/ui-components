import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.96baa54a.js";import{s as r,j as h,a as t,C as d}from"./index.572cdb40.js";import{c as s,t as o}from"./theme.ed4b6f91.js";import{$ as H}from"./OverlayArrow.module.96eee65c.js";import{B as y}from"./BodyPortal.7d3d0c1d.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
