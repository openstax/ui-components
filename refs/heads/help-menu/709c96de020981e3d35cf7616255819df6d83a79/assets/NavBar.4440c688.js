import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.337fe274.js";import{s as r,j as h,a as t,C as d}from"./index.f09d4694.js";import{c as s,t as o}from"./theme.e36af20f.js";import{$ as H}from"./OverlayArrow.module.1c35a28b.js";import{a as y}from"./BodyPortal.a7e76a6d.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
