import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.5e175548.js";import{s as r,j as h,a as t,C as d}from"./index.2eec5f8b.js";import{c as s,t as o}from"./theme.d4ba8bf4.js";import{$ as H}from"./OverlayArrow.module.a98b95f6.js";import{a as y}from"./BodyPortal.fa4021d2.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
