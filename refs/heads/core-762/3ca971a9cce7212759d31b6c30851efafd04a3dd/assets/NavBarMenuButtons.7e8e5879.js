import{s as r,C as d,j as l,a as t}from"./index.fb959489.js";import{t as o,c as s}from"./theme.0336608a.js";import{B as $}from"./BodyPortal.ff313331.js";import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.fa5779ff.js";import{$ as H}from"./OverlayArrow.module.690c2210.js";const y=4,N=4,z=2.4,L=2.4,j=r.svg`
  display: block;
  width: auto;
  height: ${L}rem;
...
`,q=({logo:e=!1,maxWidth:a,navDesktopHeight:n,navMobileHeight:i,justifyContent:c,...h})=>{const m=typeof e=="object",g=m&&"href"in e,{alt:b="OpenStax Logo",...f}=m?e:{},v=e?t(C,{alt:b}):null;return t(P,{tagName:"nav",slot:"nav",...h,children:l(D,{maxWidth:a,navDesktopHeight:n||y,navMobileHeight:i||N,justifyContent:c,children:[g?t("a",{...f,children:v}):v,h.children]})})},V=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>l(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
...
`,p=({isMenu:e,children:a,popoverProps:n,...i})=>{const c=e?B:w,h=e?k:M;return l(c,{children:[t(V,{...i}),t(S,{...n,children:t(h,{children:a})})]})},F=e=>t(p,{...e,isMenu:!1}),J=e=>t(p,{...e,isMenu:!0});export{V as N,E as P,J as a,I as b,F as c,q as d,C as e};
