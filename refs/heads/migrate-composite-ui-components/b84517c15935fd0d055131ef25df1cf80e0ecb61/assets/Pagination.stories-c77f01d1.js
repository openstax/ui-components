import{r as x,s as E,j as a,a as f,F,R as y}from"./index-7b5cc3ce.js";import{p}from"./palette-12edeb86.js";function v(t,i){return i<t?[]:Array.from({length:i-t}).map((n,e)=>e+t)}function S(t){const{currentPage:i,totalPages:n,showFromEnd:e,showFromCurrent:s}=t,o=[Math.max(1,Math.min(i-s,n+1)),Math.min(n,i+s)+1],l=[1,Math.min(o[0],e+1)],r=[Math.max(1,o[1],n-e+1),n+1];return{startRange:l,middleRange:o,endRange:r}}function k(t){return Math.max(0,t[1]-t[0])}function j(t,i,n){const e=k(t),s=k(i),o=k(n),l=t[1]===i[0]?0:1,r=i[1]===n[0]?0:1;return e+s+o+l+r}function z(t,i,n){const{startRange:e,middleRange:s,endRange:o}=t,l=j(e,s,o);if(l>=n)return t;let r=n-l;const c=Math.floor(r/2),P=s[0]-e[1],g=o[0]-s[1],u=Math.min(P,g===0?r:g<r-c?r-g+1:c);r-=u;const R=Math.min(g,r),m=[Math.max(1,s[0]-u),Math.min(i+1,s[1]+R)],C=[e[0],Math.min(m[0],e[1])],b=[Math.max(m[1],o[0]),o[1]];return{startRange:C,middleRange:m,endRange:b}}function $(t){const{totalPages:i,showFromEnd:n,showFromCurrent:e}=t,s=n*2+e*2+1+2;let o=S(t);o=z(o,i,s);const{startRange:l,middleRange:r,endRange:c}=o;return{startRange:l,middleRange:r,endRange:c,showFirstEllipsis:l[1]!==r[0],showSecondEllipsis:r[1]!==c[0]}}function I({currentPage:t,totalPages:i,showFromEnd:n,showFromCurrent:e}){return x.useMemo(()=>$({currentPage:t,totalPages:i,showFromEnd:n,showFromCurrent:e}),[t,i,n,e])}const d=E(({page:t,current:i,href:n,onClick:e,className:s})=>{const o=i?"page":void 0;return a("a",{className:s,"aria-label":`Page ${t}`,"aria-current":o,href:n||"#",onClick:e,children:t})})`
