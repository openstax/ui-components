import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.fc29c3c2.js";import{s as r,j as h,a as t,C as d}from"./index.42ac0c1e.js";import{c as s,t as o}from"./theme.a24d6312.js";import{$ as H}from"./OverlayArrow.module.28184022.js";import{a as y}from"./BodyPortal.131957dc.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
