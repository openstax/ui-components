import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.4bd5b4e0.js";import{s as r,j as h,a as t,C as d}from"./index.1725ba47.js";import{c as s,t as o}from"./theme.9e7aa81e.js";import{$ as H}from"./OverlayArrow.module.cb573b65.js";import{a as y}from"./BodyPortal.0328b2d2.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
