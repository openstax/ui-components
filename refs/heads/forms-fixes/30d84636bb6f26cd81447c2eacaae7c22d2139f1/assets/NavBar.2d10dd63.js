import{c as u,b as x,a as w,m as B,$ as k,l as M}from"./Dialog.module.4d3b93f1.js";import{s as r,j as h,a as t,C as d}from"./index.0edc2388.js";import{c as s,t as o}from"./theme.ca682476.js";import{$ as H}from"./OverlayArrow.module.edbbe1cc.js";import{a as y}from"./BodyPortal.db63d269.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
...
`,g=({isMenu:e,children:a,popoverProps:n,...i})=>{const c=e?w:B,l=e?k:M;return h(c,{children:[t(N,{...i}),t(L,{...n,children:t(l,{children:a})})]})},F=e=>t(g,{...e,isMenu:!1}),J=e=>t(g,{...e,isMenu:!0}),j=4,C=4,P=2.4,D=2.4,V=r.svg`
  display: block;
  width: auto;
  height: ${D}rem;
