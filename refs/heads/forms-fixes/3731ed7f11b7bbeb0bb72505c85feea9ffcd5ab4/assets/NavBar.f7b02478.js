import{c as u,b as x,a as B,m as w,$ as k,l as M}from"./Dialog.module.9d4ae3d5.js";import{s as r,j as h,a as t,C as d}from"./index.73850c62.js";import{c as s,t as o}from"./theme.21fc0e19.js";import{$ as H}from"./OverlayArrow.module.1627d98c.js";import{B as y}from"./BodyPortal.0581a868.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
