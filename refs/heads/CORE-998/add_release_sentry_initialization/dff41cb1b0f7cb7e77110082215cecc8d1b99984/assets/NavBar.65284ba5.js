import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.1af701d4.js";import{s as r,j as h,a as t,C as d}from"./index.90f9d8bf.js";import{c as s,t as o}from"./theme.f8c52f16.js";import{$ as H}from"./Button.module.7f0229a9.js";import{B as y}from"./BodyPortal.dc75b2b4.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
