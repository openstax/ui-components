import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.aa9aadd6.js";import{s as r,j as h,a as t,C as d}from"./index.86b5046c.js";import{c as s,t as o}from"./theme.1c05b18b.js";import{$ as H}from"./Button.module.b1ab226b.js";import{B as y}from"./BodyPortal.a60c0ec5.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
