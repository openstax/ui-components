...
`,x=a.div`
  ...
  margin: 0 auto;
  ${e=>h.breakpoints.desktop(i`
    height: ${e.navDesktopHeight}rem;
  `)}
  @media print { display: none; }
`,j=({logo:e=!1,maxWidth:s,navDesktopHeight:v,navMobileHeight:r,justifyContent:d,...o})=>{const l=typeof e=="object",m=l&&"href"in e,{alt:p="OpenStax Logo",...g}=l?e:{},n=e?t(k,{alt:p}):null;return t(w,{role:"toolbar",...o,children:c(x,{maxWidth:s,navDesktopHeight:v||b,navMobileHeight:r||f,justifyContent:d,children:[m?t("a",{...g,children:n}):n,o.children]})})};export{j as N};
