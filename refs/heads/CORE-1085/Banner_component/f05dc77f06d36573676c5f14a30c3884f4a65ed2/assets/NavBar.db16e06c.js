import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.b99d1c61.js";import{s as r,j as h,a as t,C as d}from"./index.73d4fe07.js";import{c as s,t as o}from"./theme.492f6a78.js";import{$ as H}from"./Button.module.3f0cc27b.js";import{B as y}from"./BodyPortal.b1fb2ffc.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
