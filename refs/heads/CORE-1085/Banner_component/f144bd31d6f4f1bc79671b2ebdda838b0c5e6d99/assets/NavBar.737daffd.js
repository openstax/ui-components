import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.2e89f49b.js";import{s as r,j as h,a as t,C as d}from"./index.03d519e8.js";import{c as s,t as o}from"./theme.26768929.js";import{$ as H}from"./Button.module.f7c982d8.js";import{B as y}from"./BodyPortal.8118ceb3.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
