...
`,M=l.div`
  ...
  margin: 0 auto;
  ${t=>n.breakpoints.desktop(h`
    height: ${t.navDesktopHeight}rem;
  `)}
  @media print { display: none; }
`,i=({logo:t=!1,maxWidth:a,...o})=>{const c=typeof t=="object",r=c&&"href"in t,{alt:v="OpenStax Logo",...m}=c?t:{},d=t?e(w,{alt:v}):null;return e(k,{children:s(M,{className:o.className,maxWidth:a,navDesktopHeight:o.navDesktopHeight||g,navMobileHeight:o.navMobileHeight||p,justifyContent:o.justifyContent,children:[r?e("a",{...m,children:d}):d,o.children]})})},$=()=>e(i,{children:"NavBar"}),L=()=>e(i,{logo:!0,children:"Menu"}),j=()=>e(i,{logo:{alt:"custom alt",href:"/"}}),C=()=>e(i,{logo:{alt:"custom alt unlinked"}}),z=()=>e(i,{justifyContent:"center",children:e("strong",{children:"Centered Menu"})});typeof window<"u"&&window.document&&window.document.createElement&&document.documentElement.setAttribute("data-storyloaded","");export{j as AltTextLinkedLogo,C as AltTextNoLinkedLogo,L as LogoAndChildren,z as OverrideJustifyContent,$ as Plain};
