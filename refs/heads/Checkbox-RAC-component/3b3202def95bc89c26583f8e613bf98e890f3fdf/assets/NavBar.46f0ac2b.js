import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.8a3203e7.js";import{s as r,j as h,a as t,C as d}from"./index.f5f3f699.js";import{c as s,t as o}from"./theme.c41fbeb7.js";import{$ as H}from"./Button.module.7faf4a52.js";import{B as y}from"./BodyPortal.9e1c7524.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
