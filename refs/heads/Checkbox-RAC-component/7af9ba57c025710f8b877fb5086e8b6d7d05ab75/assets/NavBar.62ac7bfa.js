import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.ea8ede0c.js";import{s as r,j as h,a as t,C as d}from"./index.0226d2e0.js";import{c as s,t as o}from"./theme.2f0b88da.js";import{$ as H}from"./Button.module.e6b0bef9.js";import{B as y}from"./BodyPortal.51e49c52.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
