import{s as r,C as d,j as l,a as t}from"./index.007141e8.js";import{t as o,c as s,d as u}from"./theme.e1533d60.js";import{B as x}from"./BodyPortal.06db6b8e.js";import{c as B,b as k,a as w,l as M,$ as H,k as y}from"./Dialog.module.8a74b3e6.js";import{$ as N}from"./Button.module.6d763fb0.js";const z=4,L=4,j=2.4,C=2.4,P=r.svg`
  display: block;
  width: auto;
  height: ${C}rem;
...
`,E=({logo:e=!1,maxWidth:a,navDesktopHeight:n,navMobileHeight:i,justifyContent:c,ariaLabel:h,...m})=>{const v=typeof e=="object",b=v&&"href"in e,{alt:f="OpenStax Logo",...$}=v?e:{},p=e?t(D,{alt:f}):null;return t(V,{tagName:"nav",ariaLabel:h,slot:"nav",...m,children:l(I,{maxWidth:a,navDesktopHeight:n||z,navMobileHeight:i||L,justifyContent:c,children:[b?t("a",{...$,children:p}):p,m.children]})})},O=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>l(N,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
...
`,g=({isMenu:e,children:a,popoverProps:n,...i})=>{const c=e?w:M,h=e?H:y;return l(c,{children:[t(O,{...i}),t(W,{...n,children:t(h,{children:a})})]})},K=e=>t(g,{...e,isMenu:!1}),Q=e=>t(g,{...e,isMenu:!0});export{O as N,J as P,Q as a,S as b,K as c,E as d,D as e,W as f};
