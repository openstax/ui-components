import{s as p,a as n,j as f,R as F}from"./index.51d91d8e.js";import{p as M}from"./palette.5e342580.js";const s=p(({page:r,current:i,href:e,onClick:t,className:g})=>{const P=i?"page":void 0;return n("a",{className:g,"aria-label":`Page ${r}`,"aria-current":P,href:e||"#",onClick:t,children:r})})`
