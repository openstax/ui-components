import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.bb22c08f.js";import{s as r,j as h,a as t,C as d}from"./index.cc4cf4d6.js";import{c as s,t as o}from"./theme.df157495.js";import{$ as H}from"./Button.module.c427d024.js";import{B as y}from"./BodyPortal.3a4b03c4.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
