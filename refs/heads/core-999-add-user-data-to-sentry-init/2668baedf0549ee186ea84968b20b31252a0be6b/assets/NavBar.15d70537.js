import{c as u,b as x,a as B,l as k,$ as w,k as M}from"./Dialog.module.0c0e4ad1.js";import{s as r,j as h,a as t,C as d}from"./index.6257544b.js";import{c as s,t as o}from"./theme.9e4ddf18.js";import{$ as H}from"./Button.module.c8774860.js";import{B as y}from"./BodyPortal.5abcff9f.js";const N=r(({label:e,icon:a,className:n,"aria-label":i,...c})=>h(H,{className:n,"aria-label":i,...c,children:[a&&(typeof a=="string"?t("img",{"aria-hidden":"true",src:a,alt:""}):a),e?t("span",{children:e}):null]}))`
  border: none;
  background: none;
  padding: 0;
  min-height: 4rem;
