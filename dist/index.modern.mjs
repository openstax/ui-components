...
`),e=>(e=>{var t;const r=Y[e];return i(E||(E=I`
  ...
  `),r.background,r.color,null!=(t=r.fontWeight)?t:700,r.backgroundHover,r.backgroundActive)})(e.variant)),K=t=>{const{disabled:r,isWaiting:i,waitingText:a,children:n,variant:c="primary"}=t,s=l(t,F);return e(q,o({},s,{disabled:i||r,variant:c,children:i&&a||n}))},P=r=>t(O,o({},r,{variant:"error",heading:"Error",children:[e(T,{}),e(G,{children:e(K,{onClick:r.onModalClose,children:"OK"})})]}));let U,Z,J,Q,X=e=>e;const ee=r.div(U||(U=X`
  min-height: 5rem;
  background-color: white;
...
`),e=>!e.inline&&i(Z||(Z=X`
  ...
  `),500,e.dismissAfterMs-500):null,e=>e.inline&&i(Q||(Q=X`
    margin: 0 auto;
    box-shadow: none;
    border: 1px solid rgba(0,0,0,0.2);
  `)),h.palette.darkerGreen,h.palette.paleGreen,h.palette.neutralDarker,h.palette.neutralLighter,h.palette.darkRed,h.palette.paleRed,h.palette.neutralDark),te=({id:r,title:i,children:a,variant:o="neutral",inline:l=!1,dismissAfterMs:c,onDismiss:s})=>{const[d,h]=n.useState(!0);return c&&(c=Math.max(c,1e3)),n.useEffect(()=>{if(!c)return;const e=setTimeout(()=>{h(!1),s&&s(r)},c);return()=>{clearTimeout(e)}},[]),d?e(ee,{dismissAfterMs:c,inline:l,children:t("div",{className:o,children:[e("div",{className:"title",children:i}),e("div",{className:"body",children:a})]})}):null};let re,ie,ae=e=>e;const ne=r.div(re||(re=ae`
  ${0}
  z-index: ${0};
  display: grid;
  ...
  justify-content: center;
  gap: 1vh;
`),e=>!e.inline&&i(ie||(ie=ae`
    position: fixed;
    right: 2rem;
  `)),m.toasts),oe=({toasts:t,onDismissToast:r,inline:i=!1})=>e(ne,{inline:i,children:t.map((t,a)=>e(te,o({onDismiss:r,inline:i},t,{children:t.message}),`toast-${a}`))});let le,ce,se,de,he,me,fe,ge,pe=e=>e;const ue=a(le||(le=pe`
  from {
    transform: scale(0);
  }
...
`),2.4,g.breakpoints.desktop(i(Me||(Me=Ce`
  ...
  ${0}
`),g.zIndex.navbar,g.colors.palette.white,g.padding.navbar.mobile,g.breakpoints.desktop(i(Ae||(Ae=Re`
    padding: 0 ${0}rem;
  `),g.padding.navbar.mobile))),Se=r.div(Ne||(Ne=Re`
  overflow: visible;
  display: flex;
  justify-content: ${0};
  align-items: center;
...
`),e=>e.justifyContent||"space-between",e=>e.navMobileHeight,e=>e.maxWidth?`max-width: ${e.maxWidth}rem;`:null,e=>g.breakpoints.desktop(i(We||(We=Re`
    height: ${0}rem;
  `),e.navDesktopHeight))),Ge=r=>{let{logo:i=!1,maxWidth:a}=r,n=l(r,je);const c="object"==typeof i,s=c&&"href"in i,d=c?i:{},{alt:h="OpenStax Logo"}=d,m=l(d,De),f=i?e(He,{alt:h}):null;return e(Be,{children:t(Se,{maxWidth:a,navDesktopHeight:n.navDesktopHeight||4,navMobileHeight:n.navMobileHeight||4,justifyContent:n.justifyContent,children:[s?e("a",o({},m,{children:f})):f,n.children]})})},Oe=["children","variant","bold","size"];let Te,Ee,Ie=e=>e;const Ye={primary:{accentColor:h.palette.mediumBlue,boxShadow:"none"},light:{accentColor:h.palette.white,boxShadow:"0 0 1px 0"}},Fe=r.label(Te||(Te=Ie`
  font-size: 1.4rem;
  display: flex;
  align-items: center;
  font-weight: ${0}
`),e=>e.bold?700:400),_e=r.input(Ee||(Ee=Ie`
  accent-color: ${0};
  width: ${0}rem;
  height: ${0}rem;
  margin: 0 1.6rem 0 0;
...
`),e=>Ye[e.variant].accentColor,e=>e.checkboxSize,e=>e.checkboxSize,e=>Ye[e.variant].boxShadow),qe=r=>{let{children:i,variant:a="primary",bold:n=!1,size:c=1.6}=r,s=l(r,Oe);return t(Fe,{bold:n,children:[e(_e,o({},s,{type:"checkbox",variant:a,checkboxSize:c})),i]})};export{K as Button,qe as Checkbox,T as Error,P as ErrorModal,$e as Loader,O as Modal,N as ModalBody,A as ModalBodyHeading,G as ModalFooter,Ge as NavBar,He as NavBarLogo,oe as ToastContainer,Ye as checkboxVariants,h as colors,f as padding,m as zIndex};
