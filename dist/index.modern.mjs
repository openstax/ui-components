...
`),e=>(e=>{var t;const r=I[e];return i(T||(T=E`
    background-color: ${0};
    color: ${0};
    font-weight: ${0};
  ...
  `),r.background,r.color,null!=(t=r.fontWeight)?t:700,r.backgroundHover,r.backgroundActive)})(e.variant)),q=t=>{const{disabled:r,isWaiting:i,waitingText:a,children:n,variant:c="primary"}=t,s=l(t,Y);return e(_,o({},s,{disabled:i||r,variant:c,children:i&&a||n}))},K=r=>t(O,o({},r,{variant:"error",heading:"Error",children:[t(N,{children:[e(A,{children:"Uh-oh, there's been a glitch"}),"We're not quite sure what went wrong. Restart your browser. If this doesn't solve the problem, visit our ",e("a",{href:"https://openstax.secure.force.com/help",target:"_blank",children:"Support Center"}),"."]}),e(G,{children:e(q,{onClick:r.onModalClose,children:"OK"})})]}));let P,U,Z,J,Q=e=>e;const X=r.div(P||(P=Q`
  min-height: 5rem;
  background-color: white;
...
`),e=>!e.inline&&i(U||(U=Q`
  ...
  `),500,e.dismissAfterMs-500):null,e=>e.inline&&i(J||(J=Q`
    margin: 0 auto;
    box-shadow: none;
    border: 1px solid rgba(0,0,0,0.2);
  `)),h.palette.darkerGreen,h.palette.paleGreen,h.palette.neutralDarker,h.palette.neutralLighter,h.palette.darkRed,h.palette.paleRed,h.palette.neutralDark),ee=({id:r,title:i,children:a,variant:o="neutral",inline:l=!1,dismissAfterMs:c,onDismiss:s})=>{const[d,h]=n.useState(!0);return c&&(c=Math.max(c,1e3)),n.useEffect(()=>{if(!c)return;const e=setTimeout(()=>{h(!1),s&&s(r)},c);return()=>{clearTimeout(e)}},[]),d?e(X,{dismissAfterMs:c,inline:l,children:t("div",{className:o,children:[e("div",{className:"title",children:i}),e("div",{className:"body",children:a})]})}):null};let te,re,ie=e=>e;const ae=r.div(te||(te=ie`
  ${0}
  z-index: ${0};
  display: grid;
  ...
  justify-content: center;
  gap: 1vh;
`),e=>!e.inline&&i(re||(re=ie`
    position: fixed;
    right: 2rem;
  `)),m.toasts),ne=({toasts:t,onDismissToast:r,inline:i=!1})=>e(ae,{inline:i,children:t.map((t,a)=>e(ee,o({onDismiss:r,inline:i},t,{children:t.message}),`toast-${a}`))});let oe,le,ce,se,de,he,me,fe,ge=e=>e;const pe=a(oe||(oe=ge`
  from {
    transform: scale(0);
  }
...
`),2.4,g.breakpoints.desktop(i(ze||(ze=Me`
  ...
  ${0}
`),g.zIndex.navbar,g.colors.palette.white,g.padding.navbar.mobile,g.breakpoints.desktop(i(Ve||(Ve=We`
    padding: 0 ${0}rem;
  `),g.padding.navbar.mobile))),Be=r.div(Ae||(Ae=We`
  overflow: visible;
  display: flex;
  justify-content: ${0};
  align-items: center;
...
`),e=>e.justifyContent||"space-between",e=>e.navMobileHeight,e=>e.maxWidth?`max-width: ${e.maxWidth}rem;`:null,e=>g.breakpoints.desktop(i(Ne||(Ne=We`
    height: ${0}rem;
  `),e.navDesktopHeight))),Se=r=>{let{logo:i=!1,maxWidth:a}=r,n=l(r,He);const c="object"==typeof i,s=c&&"href"in i,d=c?i:{},{alt:h="OpenStax Logo"}=d,m=l(d,je),f=i?e(Le,{alt:h}):null;return e(Re,{children:t(Be,{maxWidth:a,navDesktopHeight:n.navDesktopHeight||4,navMobileHeight:n.navMobileHeight||4,justifyContent:n.justifyContent,children:[s?e("a",o({},m,{children:f})):f,n.children]})})},Ge=["children","variant","bold","size"];let Oe,Te,Ee=e=>e;const Ie={primary:{accentColor:h.palette.mediumBlue,boxShadow:"none"},light:{accentColor:h.palette.white,boxShadow:"0 0 1px 0"}},Ye=r.label(Oe||(Oe=Ee`
  font-size: 1.4rem;
  display: flex;
  align-items: center;
  font-weight: ${0}
`),e=>e.bold?700:400),Fe=r.input(Te||(Te=Ee`
  accent-color: ${0};
  width: ${0}rem;
  height: ${0}rem;
  margin: 0 1.6rem 0 0;
...
`),e=>Ie[e.variant].accentColor,e=>e.checkboxSize,e=>e.checkboxSize,e=>Ie[e.variant].boxShadow),_e=r=>{let{children:i,variant:a="primary",bold:n=!1,size:c=1.6}=r,s=l(r,Ge);return t(Ye,{bold:n,children:[e(Fe,o({},s,{type:"checkbox",variant:a,checkboxSize:c})),i]})};export{q as Button,_e as Checkbox,K as ErrorModal,ke as Loader,O as Modal,N as ModalBody,A as ModalBodyHeading,G as ModalFooter,Se as NavBar,Le as NavBarLogo,ne as ToastContainer,Ie as checkboxVariants,h as colors,f as padding,m as zIndex};
