...
export declare const SidebarNav: import("styled-components").StyledComponent<({ className, id, ...props }: SidebarNavSharedProps) => import("react/jsx-runtime").JSX.Element, any, {}, never>;
export declare const BodyPortalSidebarNav: import("styled-components").StyledComponent<({ className, id, ...props }: SidebarNavSharedProps) => import("react/jsx-runtime").JSX.Element, any, {}, never>;
