import { PaginationConfig, PaginationRanges } from "./utils";
/**
 ...
 * ```
 */
export declare function usePaginationRanges({ currentPage, totalPages, showFromEnd, showFromCurrent, }: PaginationConfig): PaginationRanges;
