...
export declare const TextInput: ({ label, addon, help, wrapperProps, onChangeValue, ...props }: TextInputProps) => JSX.Element;
declare type TextAreaProps = React.ComponentPropsWithoutRef<'textarea'> & InputProps & {
    wrapperProps?: React.ComponentPropsWithoutRef<'label'>;
    onChangeValue?: (value: any) => void;
    transformValue?: (value: string | undefined) => any;
};
export declare const TextArea: ({ label, help, wrapperProps, onChangeValue, ...props }: TextAreaProps) => JSX.Element;
...
export declare const Select: ({ onChangeValue, onOptionDisappear, onOptionAppear, onOptionReappear, label, help, options, wrapperProps, ...props }: SelectProps) => JSX.Element;
declare type RadioProps = React.ComponentPropsWithoutRef<'input'> & InputProps & {
    onChangeValue?: (value: boolean | undefined) => void;
    wrapperProps?: React.ComponentPropsWithoutRef<'label'>;
};
export declare const Radio: ({ label, help, wrapperProps, onChangeValue, ...props }: RadioProps) => JSX.Element;
declare type CheckboxProps = React.ComponentPropsWithoutRef<'input'> & InputProps & {
    onChangeValue?: (value: boolean | undefined) => void;
    wrapperProps?: React.ComponentPropsWithoutRef<'label'>;
};
export declare const Checkbox: ({ label, help, wrapperProps, onChangeValue, ...props }: CheckboxProps) => JSX.Element;
...
export declare const File: ({ label, help, wrapperProps, onChangeValue, uploader, value, ...props }: FileProps) => JSX.Element;
export {};
