...
export declare const TextInput: ({ label, addon, help, transformValue, wrapperProps, onChangeValue, ...props }: TextInputProps) => import("react/jsx-runtime").JSX.Element;
declare type TextAreaProps = React.ComponentPropsWithoutRef<'textarea'> & InputProps & {
    wrapperProps?: React.ComponentPropsWithoutRef<'label'>;
    onChangeValue?: (value: any) => void;
    transformValue?: (value: string | undefined) => any;
};
export declare const TextArea: ({ label, help, transformValue, wrapperProps, onChangeValue, ...props }: TextAreaProps) => import("react/jsx-runtime").JSX.Element;
...
export declare const Select: ({ onChangeValue, onOptionDisappear, onOptionAppear, onOptionReappear, label, help, transformValue, options, wrapperProps, ...props }: SelectProps) => import("react/jsx-runtime").JSX.Element;
...
declare type CheckboxProps = React.ComponentPropsWithoutRef<'input'> & InputProps & Parameters<typeof StyledCheckbox>[0] & {
    onChangeValue?: (value: boolean | undefined) => void;
    wrapperProps?: React.ComponentPropsWithoutRef<'label'>;
    error?: string[];
};
export declare const Checkbox: ({ label, help, wrapperProps, error, onChangeValue, ...props }: CheckboxProps) => import("react/jsx-runtime").JSX.Element;
...
declare type RangeProps = React.ComponentPropsWithoutRef<'input'> & InputProps & {
    wrapperProps?: React.ComponentPropsWithoutRef<'label'>;
...
export declare const RangeInput: ({ label, help, wrapperProps, onChangeValue, labels, ...props }: RangeProps) => import("react/jsx-runtime").JSX.Element;
export {};
