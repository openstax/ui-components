...
declare type FormStateHelpers<T extends {}> = {
    data: Partial<T>;
    submit: () => void;
    namespace: string;
...
export declare const useFormState: <T extends {}>(state: FetchState<T, string>, defaultValue?: Partial<T> | undefined, onSubmit?: ((data: Partial<T>) => void) | undefined) => FormStateHelpers<T>;
