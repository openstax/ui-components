...
const buttonStyleSets = asButtonStyleSetTypes({
    primary: {
        ...
        backgroundActive: palette_1.palette.orangeActive,
        backgroundHover: palette_1.palette.orangeHover,
    ...
    secondary: {
        ...
        backgroundActive: palette_1.palette.darkGrayActive,
        backgroundHover: palette_1.palette.darkGrayHover,
        color: palette_1.palette.white,
        outline: palette_1.palette.white,
        shadow: palette_1.palette.black,
    },
