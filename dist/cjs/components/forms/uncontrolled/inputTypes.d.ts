...
export declare const TextInput: ({ label, addon, help, transformValue, wrapperProps, onChangeValue, className, ...props }: TextInputProps) => import("react/jsx-runtime").JSX.Element;
...
type CheckboxProps = React.ComponentPropsWithoutRef<'input'> & InputProps & Parameters<typeof StyledCheckbox>[0] & {
