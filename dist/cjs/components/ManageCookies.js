...
const ManageCookiesLink = ({ children, className, wrapper, ...props }) => {
    ...
    const useIsomorphicLayoutEffect = inBrowser ? react_1.default.useLayoutEffect : react_1.default.useEffect;
    ...
    if (!cookieYesLoaded) {
        return (0, jsx_runtime_1.jsx)("style", { dangerouslySetInnerHTML: { __html: revisitStyleCss } });
    }
