...
export declare const NavBarMenuItem: import("styled-components").StyledComponent<(<T extends object>(props: import("react-aria-components").MenuItemProps<T> & React.RefAttributes<T>) => React.ReactElement | null), any, {}, never>;
export declare const PopoverContainer: import("styled-components").StyledComponent<"div", any, {}, never>;
export declare const NavBarPopover: import("styled-components").StyledComponent<(props: PopoverProps & React.RefAttributes<HTMLElement>) => React.ReactElement | null, any, {}, never>;
