...
const NavBar = ({ logo = false, maxWidth, navDesktopHeight, navMobileHeight, justifyContent, ariaLabel, className, style, ...props }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(BodyPortal_1.BodyPortal, { tagName: 'nav', ariaLabel: ariaLabel, slot: 'nav', className: (0, classnames_1.default)('navbar-wrapper', className), style: style, ...props, children: (0, jsx_runtime_1.jsxs)("div", { className: "navbar-bar", style: barStyle, children: [renderAnchor ? (0, jsx_runtime_1.jsx)("a", { ...anchorProps, children: logoComponent }) : logoComponent, props.children] }) }));
};
