...
exports.calculatePaginationRanges = exports.range = void 0;
/**
 ...
 */
function calculateInitialRanges(config) {
    ...
    const startRange = [1, Math.min(middleRange[0], showFromEnd + 1)];
 ...
 */
function countTotalEntries(startRange, middleRange, endRange) {
 ...
 */
function adjustRangesToMeetMinimum(ranges, totalPages, minEntries) {
 ...
 */
function calculatePaginationRanges(config) {
    ...
    const minEntries = showFromEnd * 2 + // Pages at start and end
...
exports.calculatePaginationRanges = calculatePaginationRanges;
