...
const loadSvg = (0, styled_components_1.keyframes) `
  from {
    transform: scale(0);
  }
...
`;
const moveGreen = (0, styled_components_1.keyframes) `
  from {
...
`;
const moveOrange = (0, styled_components_1.keyframes) `
  from {
    transform: matrix(1, 0, 0, 1, 0, 0);
  }
...
`;
const moveGray = (0, styled_components_1.keyframes) `
  from {
    transform: matrix(1, 0, 0, 1, 0, 0);
  }
...
`;
const moveYellow = (0, styled_components_1.keyframes) `
  from {
    transform: matrix(1, 0, 0, 1, 0, 0);
  }
...
`;
const moveBlue = (0, styled_components_1.keyframes) `
  from {
    transform: matrix(1, 0, 0, 1, 0, 0);
  }
...
`;
const LoadingIcon = styled_components_1.default.svg `
  enable-background: new 0 0 57.6 39.1;
  animation: ${loadSvg} 0.3s forwards ${(props) => props.delay || 300}ms;
  display: block;
  height: 100%;
  margin: 0 auto;
  opacity: 0;
  ...
  width: 5rem;
  ${(props) => props.large ? (0, styled_components_1.css) `
    width: 10rem;
   ` : ''}
