...
export const themeTokenGroups = [
    {
        ...
        tokens: Object.entries(palette).map(([key, value]) => [`--ox-color-${kebab(key)}`, value]),
    },
    {
    ...
    },
    {
        ...
        tokens: Object.entries(zIndex).map(([key, value]) => [`--ox-z-index-${kebab(key)}`, String(value)]),
    },
    {
...
export const themeTokens = () => new Map(themeTokenGroups.flatMap((group) => group.tokens));
const header = `/*
 * Global theme tokens.
 *
