 ...
 */
export const mapHiddenFields = (supportInfoMapping) => Object.fromEntries(HIDDEN_FIELDS_MAPPING
 ...
 */
export const mapVisibleFields = (supportInfoMapping) => {
 ...
 */
export const getPreChatFields = (contactFormParams) => {
