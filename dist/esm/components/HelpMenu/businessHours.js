 ...
 * @returns The current business hours window, or undefined if outside hours
 */
export const useBusinessHours = (hoursResponse, gracePeriod = 5000) => {
 ...
 */
export const formatBusinessHoursRange = (startTime, endTime) => {
 ...
 */
export const useHoursRange = (businessHours, gracePeriod) => {
    const hours = useBusinessHours(businessHours, gracePeriod);
    return React.useMemo(() => (hours ? formatBusinessHoursRange(hours.startTime, hours.endTime) : undefined), [hours]);
};
