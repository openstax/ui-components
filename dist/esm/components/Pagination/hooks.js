...
import { calculatePaginationRanges, } from "./utils";
/**
 ...
 * ```
 */
export function usePaginationRanges({ currentPage, totalPages, showFromEnd, showFromCurrent, }) {
    return useMemo(() => calculatePaginationRanges({
        currentPage,
        totalPages,
        showFromEnd,
        showFromCurrent,
