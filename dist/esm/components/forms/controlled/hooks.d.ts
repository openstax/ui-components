...
export declare const useFormState: <T extends AbstractFormData>(state: FormStateHelpers<T>["state"], defaultValue?: Partial<T>, onSubmit?: (data: Partial<T>) => void) => FormStateHelpers<T>;
