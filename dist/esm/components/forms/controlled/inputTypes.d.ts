...
type MakeControlled<T extends React.ComponentType<any>> = Omit<React.ComponentPropsWithoutRef<T>, 'value'> & {
    name: string;
    emptyDisabledValue?: boolean;
};
type MakeControlledCheckbox<T extends React.ComponentType<any>> = Omit<React.ComponentPropsWithoutRef<T>, 'checked'> & {
    name: string;
    emptyDisabledValue?: boolean;
};
